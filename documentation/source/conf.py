...
# built documents.
with open("../../spinalcordtoolbox/version.txt", "r") as f:
    _v = Version(f.readline().strip())
...
extlinks = {
    ...
    'sct_tutorial_data': ('https://github.com/spinalcordtoolbox/sct_tutorial_data/releases/download/r20260508/%s', '%s')
}
...
# -- Substitution extensions configuration --------------------------------

# Add available substitutions to rst prologues
