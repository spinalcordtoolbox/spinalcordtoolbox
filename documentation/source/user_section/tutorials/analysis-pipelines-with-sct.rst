...
To address this, SCT provides a tool called :ref:`sct_run_batch` to run processing pipelines across multi-subject datasets. This tutorial provides a brief overview of how to use this tool on an example dataset.
