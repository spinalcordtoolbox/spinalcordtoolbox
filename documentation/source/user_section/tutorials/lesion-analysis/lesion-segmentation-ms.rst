...
.. code:: sh
   ...
   # Perform initial spinal cord segmentation to crop the image to the spinal cord region for better performance
   # (Replace the `$IMAGE` variables with your own filenames)
