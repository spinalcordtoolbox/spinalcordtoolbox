...
First, we will start by computing the cord cross-sectional area (CSA) averaged across vertebral levels. As an example, we'll choose the C3 and C4 vertebral levels, but you can specify any levels that are covered by the appropriate inferior/superior disc labels present in your disc label file.
