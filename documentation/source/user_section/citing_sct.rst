...
.. list-table::
    ...
    * - :ref:`sct_deepseg_lesion_ms`
      - Benveniste PL *et al.* "`Generalizable spinal cord multiple sclerosis lesion segmentation across MRI contrasts, protocols, and centers. <https://doi.org/10.1177/13524585261427333>`__" **Multiple Sclerosis Journal** 32 (2026): 598-613.
...
.. list-table::
   ...
   * - :ref:`sct_compute_compression`
     - Bédard S, Valošek J *et al.* "`Normalizing spinal cord compression measures in degenerative cervical myelopathy <https://www.sciencedirect.com/science/article/pii/S1529943025001597>`__, **Spine J.** 2025
   ...
   * - :ref:`sct_image` ``-stitch`` (v7.4 and above)
   ...
   * - :ref:`sct_image` ``-stitch`` (v7.3 and below)
