...
# ---------------------------------------------------------------------------------------
#
# Note: This script is littered with `# noqa: F821` statements. This is because this
# script depends on several objects provided by the outer FSLeyes context:
#
#    - frame
#    - displayCtx
#    - overlayList
...
class TextBox:
    ...
    def get_highlighted_file_name(self, event):
        ...
        """
        selected_overlay = displayCtx.getSelectedOverlay()  # noqa: F821 (displayCtx is provided by FSLeyes context)
...
class TabPanelPropSeg(SCTPanel):
    ...
    def on_button_run(self, event):
        ...
        image = Image(fname_out)          # noqa: F821 (Image is provided by the fsl.data.image module)
