...
param_deepseg = [
    ({'fname_seg_manual':
        sct_dir_local_path('sct_testing_data/t2/t2_seg-deepseg_sc-2d.nii.gz'),
        'contrast': 't2', 'kernel': '2d'}),
    ({'fname_seg_manual':
        sct_dir_local_path('sct_testing_data/t2/t2_seg-deepseg_sc-3d.nii.gz'),
...
def test_deep_segmentation_spinalcord(params):
    ...
    fname_im = sct_dir_local_path('sct_testing_data/t2/t2.nii.gz')
    fname_centerline_manual = sct_dir_local_path('sct_testing_data/t2/t2_centerline-manual.nii.gz')
