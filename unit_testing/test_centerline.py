...
im_centerlines = [
    ...
    (dummy_centerline(size_arr=(30, 20, 50), subsampling=10),
     {'median': 0, 'rmse': 0.1, 'laplacian': 0.5, 'norm': 3.1},
     {}),
