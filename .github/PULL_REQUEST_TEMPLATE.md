...
Fixes #XXXX.  <!-- Replace #XXXX with the issue # that your PR will fix. If multiple issues, write "fixes" in front of each #XXXX. See https://github.com/spinalcordtoolbox/spinalcordtoolbox/wiki/Contributing:-Submitting-changes-to-SCT-(Opening-a-Pull-Request)#235-development -->
