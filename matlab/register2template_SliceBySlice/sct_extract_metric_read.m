...
% [metriclabel(cell), metriclabel(matrix)] = sct_extract_metric_read('metric_label.txt')

%IMPORTFILE Import numeric data from a text file as a matrix.
%   METRICLABEL = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   METRICLABEL = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   metriclabel = importfile('metric_label.txt', 7, 19);
%
%    See also TEXTSCAN.
