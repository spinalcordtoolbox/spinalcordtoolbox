...
sct_unix('sct_register_multimodal -i src_reslice.nii -d dest.nii -p step=1,algo=slicereg2d_affine,gradStep=30,iter=100,metric=CC:step=2,algo=slicereg2d_translation,metric=CC:step=3,algo=slicereg2d_bsplinesyn,metric=CC')
