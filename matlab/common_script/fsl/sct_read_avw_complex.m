function [img,dims,scales,bpp,endian] = sct_read_avw_complex(fname)
% Read NIFTI data in complex mode. Based on read_avw_complex.m from FSL.
% 
...
[imgr,dims,scales,bpp,endian]=sct_read_avw([fname,'R']);
[imgi,dims,scales,bpp,endian]=sct_read_avw([fname,'I']);
