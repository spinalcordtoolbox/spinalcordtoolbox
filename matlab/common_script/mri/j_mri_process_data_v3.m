...
% =========================================================================
function mri = j_mri_process_data_v3(mri)
...
% IF USER DID NOT ASK FOR INTRA-RUN MOCO
if strcmp(mri.moco_intra.method,'none')
...
for i_folder=1:nb_folders_moco
	...
	case '3d'
		...
		% estimate motion
		j_progress('Estimate motion with mcflirt ..................')
		fname_datasub = [mri.nifti.path,mri.nifti.folder{i_folder},mri.nifti.file_data];
		fname_datamoco = [mri.nifti.path,mri.nifti.folder{i_folder},mri.nifti.file_data,mri.nifti.file_data_moco];
		fname_datasub_ref = [mri.nifti.path,mri.nifti.folder{i_folder},mri.nifti.file_data_firstvols_mean];
	...
	disp(['-> File created: ',mri.nifti.file_data,mri.nifti.file_data_moco,'.nii'])
