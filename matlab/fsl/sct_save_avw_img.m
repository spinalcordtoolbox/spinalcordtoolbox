function sct_save_avw_img(img,fname,vtype,endian)
% Save an array (img) as an analyse file (only the .img) for either a 2D or 3D or 4D array (automatically determined). Based on save_avw_img.m from FSL.
% 
