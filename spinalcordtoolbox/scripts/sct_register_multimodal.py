...
def get_parser():
    ...
    optional.add_argument(
        ...
        help=(f"Parameters for registration. Separate arguments with \",\". Separate steps with \":\".\n"
              ...
              f"  - dof: <str> Degree of freedom for type=label. Separate with '_'. T stands for translation, R stands "
              f"for rotation, and S stands for scaling. x, y, and z indicate the direction. For example, "
