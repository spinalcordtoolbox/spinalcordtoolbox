...
def get_parser(ascor=False):
    ...
    parser = SCTArgumentParser(
        description=(
            ...
            "  - length_anterior: Anterior length of the spinal cord along the AP axis, measured from the cord "
            "center of mass to the anterior cord edge.\n"
            "  - length_posterior: Posterior length of the spinal cord along the AP axis, measured from the cord "
