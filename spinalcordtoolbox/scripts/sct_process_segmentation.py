...
def get_parser(ascor=False):
    ...
    parser = SCTArgumentParser(
        description=(
            ...
            "  - diameter_anterior: Anterior length of the spinal cord along the AP axis, measured from the cord "
            "center of mass to the anterior cord edge.\n"
            "  - diameter_posterior: Posterior length of the spinal cord along the AP axis, measured from the cord "
            "center of mass to the posterior cord edge.\n"
    ...
    optional.add_argument(
        ...
        metavar=Metavar.str,
        help=textwrap.dedent("""
            File with single-voxel labels identifying the intervertebral discs generated with sct_deepseg spine or sct_label_utils.
