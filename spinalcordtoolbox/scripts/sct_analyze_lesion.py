...
def get_parser():
    parser = SCTArgumentParser(
        description='Compute statistics on segmented lesions. The function assigns an ID value to each lesion (1, 2, '
                    ...
                    '- midsagittal_spinal_cord_slice: midsagittal slice of the spinal cord defined as the slice with '
                    'the largest spinal cord area (computed from the spinal cord segmentation mask)\n'
                    '- length_midsagittal_slice [mm]: length of the lesion along the Superior-Inferior (SI) axis in '
                    'the midsagittal slice\n'
                    '- width_midsagittal_slice [mm]: width of the lesion along the Anterior-Posterior (AP) axis in '
                    'the midsagittal slice\n'
