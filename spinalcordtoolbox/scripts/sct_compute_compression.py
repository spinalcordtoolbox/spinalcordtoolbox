...
def get_parser():
    parser = SCTArgumentParser(
        description='Compute normalized morphometric metrics to assess:'
                    ...
                    '\n'
                    'References:\n'
                    'Sandrine Bédard, Jan Valošek, Maryam Seif, Armin Curt, Simon Schading, Nikolai Pfender, Patrick '
                    'Freund, Markus Hupp, Julien Cohen-Adad. Normalizing Spinal Cord Compression Morphometric '
                    'Measures: Application in Degenerative Cervical Myelopathy. medRxiv 2024.03.13.24304177\n'
                    'doi.org/10.1101/2024.03.13.24304177\n'
                    '\n'
