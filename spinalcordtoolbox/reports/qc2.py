...
def sct_analyze_lesion(
    ...
    fname_label: str,
    fname_sc: str,
    measure_pd,  # pd.DataFrame,  # NB: Type hints will undo the benefits of LazyLoading
    argv: Sequence[str],
    path_qc: str,
    dataset: Optional[str],
    subject: Optional[str],
...
def add_orientation_labels(ax,  # mpl_axes.Axes, # NB: Type hints will undo the benefits of LazyLoading
                           radius: tuple[int, int] = (15, 15), letters: tuple[str, str, str, str] = ('A', 'P', 'L', 'R')):
    """
...
def add_segmentation_labels(ax,  # mpl_axes.Axes, # NB: Type hints will undo the benefits of LazyLoading
                            seg_mosaic: np.ndarray, colors: list[str],
...
def plot_outlines(img: np.ndarray, ax,  # mpl_axes.Axes, # NB: Type hints will undo the benefits of LazyLoading
                  **kwargs):
    """
