...
def add_entry(src, process, args, path_qc, plane, path_img=None, path_img_overlay=None,
    ...
    try:
        ...
        if _platform == "linux" or _platform == "linux2":
            # try catch block. The keyerror is thrown if $DOCKER is not an environment variable. This variable is set
            # in dockerfile generated by sct_docker.py. Code available at : https://github.com/neuropoly/sct_docker/blob/fe07fd752510a05b7aee6128a9ad4770ccb2d0fb/sct_docker.py#L83 
            try:  
                os.environ["DOCKER"]
