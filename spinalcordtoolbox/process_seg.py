...
def find_AP_and_RL_diameter(properties):
    ...
    :return: properties updated with new fields: diameter_AP, diameter_RL
    """
    if -45.0 < properties['orientation'] < 45.0:
        properties['diameter_RL'] = properties['major_axis_length']
        properties['diameter_AP'] = properties['minor_axis_length']
    else:
        properties['diameter_RL'] = properties['minor_axis_length']
        properties['diameter_AP'] = properties['major_axis_length']
    return properties
