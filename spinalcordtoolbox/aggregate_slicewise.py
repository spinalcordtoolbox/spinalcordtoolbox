...
def save_as_csv(agg_metric, fname_out, fname_in=None, append=False):
    ...
    list_item = [
                ...
                'MEAN(symmetry_hausdorff_RL)', 'STD(symmetry_hausdorff_RL)',
                'MEAN(symmetry_difference_RL)', 'STD(symmetry_difference_RL)',
                'MEAN(symmetry_dice_AP)', 'STD(symmetry_dice_AP)',
                'MEAN(symmetry_hausdorff_AP)', 'STD(symmetry_hausdorff_AP)',
                'MEAN(symmetry_difference_AP)', 'STD(symmetry_difference_AP)',
