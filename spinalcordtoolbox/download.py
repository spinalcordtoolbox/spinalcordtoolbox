...
DATASET_DICT = {
    ...
    "sct_testing_data": {
        "mirrors": [
            # FIXME: This link should NOT be merged to master. It should be replaced via a new sct_testing_data release.
            "https://github.com/spinalcordtoolbox/sct_testing_data/releases/download/r20210330230310/sct_testing_data-PR3977.zip",
