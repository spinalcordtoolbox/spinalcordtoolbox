...
DATASET_DICT = {
    ...
    "binaries_linux": {
        "mirrors": [
            "https://github.com/spinalcordtoolbox/spinalcordtoolbox-binaries/releases/download/r20250109/spinalcordtoolbox-binaries_linux.tar.gz",
        ],
    ...
    "binaries_osx": {
        "mirrors": [
            "https://github.com/spinalcordtoolbox/spinalcordtoolbox-binaries/releases/download/r20250109/spinalcordtoolbox-binaries_osx.tar.gz",
        ],
        "default_location": __bin_dir__,
        "download_type": "Binaries",
        "default": False,  # Technically 'True', but whether to download by default is platform-dependent
    ...
    "binaries_win": {
        "mirrors": [
            "https://github.com/spinalcordtoolbox/spinalcordtoolbox-binaries/releases/download/r20250109/spinalcordtoolbox-binaries_windows.tar.gz",
        ],
        "default_location": __bin_dir__,
        "download_type": "Binaries",
        "default": False,  # Technically 'True', but whether to download by default is platform-dependent
