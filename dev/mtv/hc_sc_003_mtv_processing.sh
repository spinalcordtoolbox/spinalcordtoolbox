...
ppath_to_ep120=/Volumes/data_shared/boston/connectome/HC_SC_003/dicom/10_ep_seg_se_FA120/20140724_092151epsegseFA120s010a1001.nii.gz
...
for fa in $FA_LIST; do
    sct_register_multimodal -i spgr${fa}.nii.gz -d spgr10.nii.gz -z 0 -p 5,sliceReg,1,MeanSquares -o spgr${fa}to10.nii.gz
done
...
sct_compute_mtvf.py -b B1angle_reg.nii -c spgr10-csf.nii.gz -f 4,10,30 -i spgr4to10.nii.gz,spgr10.nii.gz,spgr30to10.nii.gz -o T1_map,PD_map,MTVF_map -p mean-PD-in-CSF-from-mean-SPGR -s spgr10_seg -t 0.02
...
sct_apply_transfo -i MTVF_map.nii.gz -o MTVF_map_to_template.nii.gz -d ${SCT_DIR}/data/template/MNI-Poly-AMU_T2.nii.gz -w ../warping_fields/warp_mtv2template_final.nii.gz -p splineath_to_spgr4=/Volumes/data_shared/boston/connectome/HC_SC_003/dicom/8_fl3d_mtv_4/20140724_092151fl3dmtv4s008a1001.nii.gz
