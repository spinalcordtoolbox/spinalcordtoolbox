...
ax_pd.legend(loc='center right', bbox_to_anchor=(-0.01, 0.5))
ax_pd.set_xlabel('z')
...
ax_spgr.legend(loc='center right', bbox_to_anchor=(-0.01, 0.5))
ax_spgr.set_xlabel('z')

box_spgr = ax_spgr.get_position()
ax_spgr.set_position([box_spgr.x0, box_spgr.y0, box_spgr.width*0.9, box_spgr.height])
...
ax_b1.set_position([box_b1.x0, box_b1.y0, box_b1.width*0.9, box_b1.height])
