 ...
 * \brief Performs the Hough Transform to find circles in a 2D image. (NeuroPoly Implementation)
 *
 ...
 * 
 * !!! This class has been modified by NeuroPoly to allow inverse gradient for the Hough transform (GradientFactor parameter).
 *
...
public:
  ...
  /** Set the gradient factor for object detection */
  itkSetMacro(GradientFactor, double);
  itkGetConstMacro(GradientFactor, double);
