...
cmd = 'c3d ' + anat_file_reorient + ext + ' ' + anat_file_reorient_masked + ext + ' -copy-transform -o ' + anat_file_reorient_masked + ext
print('>> '+ cmd)
status, PWD = getstatusoutput(cmd)
...
cmd = 'c3d ' + template_file + ext + ' ' + template_file_masked + ext + ' -copy-transform -o ' + template_file_masked + ext
print('>> '+ cmd)
status, PWD = getstatusoutput(cmd)
