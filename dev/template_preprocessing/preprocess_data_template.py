...
path_results ='/Users/jcohen/data/template/data'
...
f_crop.close()
sct.run('sct_crop_image -i data_RPI_crop.nii.gz -dim 2 -start 2 -end 1 -b 0 -o centerline_propseg_RPI.nii.gz')
sct.run('sct_label_utils -i centerline_propseg_RPI.nii.gz -o centerline_propseg_RPI.nii.gz -t create -x 76,88,0,1:76,80,50,1:76,75,100,1:77,69,150,1:79,72,200,1:82,87,250,1:85,112,300,1:88,135,350,1:92,139,400,1:95,131,450,1:92,120,493,1')
sct.run('sct_crop_image -i data_RPI_crop.nii.gz -dim 2 -start 2 -end 1 -b 0 -o labels_updown.nii.gz')
...
f_crop.close()
sct.run('sct_label_utils -i data_RPI_crop.nii.gz -o centerline_propseg_RPI.nii.gz -t create -x 77,66,0,1:77,67,0,1:75,62,50,1:74,61,100,1:73,60,150,1:73,62,200,1:75,72,250,1:78,91,300,1:78,112,350,1:76,117,400,1:74,108,450,1:76,100,500,1:80,101,542,1')
sct.run('sct_crop_image -i data_RPI_crop.nii.gz -dim 2 -start 2 -end 1 -b 0 -o labels_updown.nii.gz')
