...
PATH_OUTPUT= '/Users/tamag/data/data_template/subjects_test_T1' #folder where you want the results to be stored
...
SUBJECTS_LIST_STR = [['errsm_10', '/Volumes/data_shared/montreal_criugm/errsm_10/13-SPINE_MEMPRAGE/echo_2.09', '/Volumes/data_shared/montreal_criugm/errsm_10/20-SPINE_SPACE'], ['errsm_11', '/Volumes/data_shared/montreal_criugm/errsm_11/24-SPINE_T1/echo_2.09', '/Volumes/data_shared/montreal_criugm/errsm_11/09-SPINE_T2'],['errsm_12', '/Volumes/data_shared/montreal_criugm/errsm_12/19-SPINE_T1/echo_2.09', '/Volumes/data_shared/montreal_criugm/errsm_12/18-SPINE_T2'],['errsm_13', '/Volumes/data_shared/montreal_criugm/errsm_13/33-SPINE_T1/echo_2.09', '/Volumes/data_shared/montreal_criugm/errsm_13/34-SPINE_T2']]
...
if do_preprocessing_T1:
   ...
   # loop across subjects
    for i in range(0,len(SUBJECTS_LIST)):
        ...
        #sct.run('isct_c3d ../T2/data_RPI_crop.nii.gz data_RPI.nii.gz -reslice-identity data_RPI_registered.nii.gz')
       ...
       #  sct.run('sct_orientation -i data.nii.gz -s RPI')
        ...
        # Set T1 image in the space of T2  (for now c3d)
        #sct.run('isct_antsRegistration --dimensionality 3 --transform syn[0.5,3,0] --metric MI[data_RPI.nii.gz,data_T2_RPI.nii.gz,1,32] --convergence 0 --shrink-factors 1 --smoothing-sigmas 0mm --restrict-deformation 1x1x0 --output [step0,data_RPI_registered.nii.gz] --interpolation BSpline[3]')
        sct.run('isct_c3d data_T2_RPI.nii.gz data_RPI.nii.gz -reslice-identity data_RPI_registered.nii.gz')

       # Construct centerline of T1
        sct.run('sct_propseg -i ')
