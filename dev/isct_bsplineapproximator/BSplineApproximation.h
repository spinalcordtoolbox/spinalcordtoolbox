...
public:
    ...
    BSplineApproximation(vector<CVector3>* centerline, int numberOfLevels=15)
    {
        ...
        ImageTypeSpline::SpacingType spacing;
        spacing.Fill( 1.0 );
        ImageTypeSpline::SizeType size;
        size.Fill( 2.0 );
        ImageTypeSpline::PointType origin;
        origin.Fill( 0.0 );
        ImageTypeSpline::RegionType region(size);
        FilterTypeSpline::ArrayType closedim;
        closedim.Fill(0);
        filter->SetSize( size );
        ...
        FilterTypeSpline::ArrayType ncps;
