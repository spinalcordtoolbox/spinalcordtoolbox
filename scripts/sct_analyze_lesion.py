...
from spinalcordtoolbox.process_lesionseg import measure_lesion
...
class AnalyzeLeion:
    ...
    def analyze(self):
        ...
        self.volumes, self.measure_pd = measure_lesion(im_lesion=Image(self.fname_label),
                                        path_template=self.path_template,
                                        im_vert=Image(self.path_levels) if os.path.isfile(self.path_levels) else None,
                                        atlas_roi_lst=self.atlas_roi_lst,
                                        measure_pd=self.measure_pd,
                                        fname_ref=self.fname_ref,
