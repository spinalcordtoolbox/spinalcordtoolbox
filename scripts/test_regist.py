...
def main(args=None):
    ...
    # Labels can be big (more than single point),
    # because when applying NN interpolation, single points might disappear
    data_src[20 - size_label:20 + size_label + 1, 20 - size_label:20 +
             size_label + 1, 10 - size_label:10 + size_label + 1] = 1
    data_src[25 - size_label:25 + size_label + 1, 25 - size_label:25 +
             size_label + 1, 20 - size_label:20 + size_label + 1] = 2
    data_src[30 - size_label:30 + size_label + 1, 30 - size_label:30 +
             size_label + 1, 30 - size_label:30 + size_label + 1] = 3
    data_src[25 - size_label:25 + size_label + 1, 25 - size_label:25 +
             size_label + 1, 40 - size_label:40 + size_label + 1] = 4
    data_src[20 - size_label:20 + size_label + 1, 20 - size_label:20 +
             size_label + 1, 50 - size_label:50 + size_label + 1] = 5
    ...
    data_dest[28 - size_label:28 + size_label + 1, 28 - size_label:28 +
              size_label + 1, 10 - size_label:10 + size_label + 1] = 1
    data_dest[29 - size_label:29 + size_label + 1, 29 - size_label:29 +
              size_label + 1, 20 - size_label:20 + size_label + 1] = 2
    data_dest[30 - size_label:30 + size_label + 1, 30 - size_label:30 +
              size_label + 1, 30 - size_label:30 + size_label + 1] = 3
    data_dest[29 - size_label:29 + size_label + 1, 29 - size_label:29 +
              size_label + 1, 40 - size_label:40 + size_label + 1] = 4
    data_dest[28 - size_label:28 + size_label + 1, 28 - size_label:28 +
    ...
    sct_apply_transfo.main('-i data_src.nii.gz -o data_src_warp.nii.gz -d data_dest.nii.gz -w warp_curve2straight.nii.gz -x nn'.split())

    # Compute DICE coefficient between src and dest
    printv('\nCompute DICE coefficient...', verbose)
    sct_dice_coefficient.main('data_dest.nii.gz data_src_warp.nii.gz -o dice.txt'.split())
