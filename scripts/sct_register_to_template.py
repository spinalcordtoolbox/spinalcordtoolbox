...
def main(args=None):
    ...
    if ref == 'template':
        ...
        for i_step in range(1, len(paramreg.steps)):
            ...
            if paramreg.steps[str(i_step)].algo == 'centermassrot' and paramreg.steps[str(i_step)].rot_method == 'auto':
                src_seg = ftmp_seg
            ...
            if i_step > 1:
                ...
                if paramreg.steps[str(i_step)].algo == 'centermassrot' and paramreg.steps[str(i_step)].rot_method == 'auto':  # also apply transformation to the seg
            ...
            if paramreg.steps[str(i_step)].algo == 'centermassrot' and paramreg.steps[str(i_step)].rot_method == 'auto': # im_seg case
