    ...
    def apply(self):
        ...
        for i in range(len(fname_warp_list)):
            ...
            if fname_warp_list[i].find('-') == 0:
                ...
                use_inverse.append('')
            sct.printv('  Transfo #' + str(i) + ': ' + use_inverse[i] +
        ...
        if nt == 1:
            ...
            # print 'HOLA1'
            sct.run('isct_antsApplyTransforms -d 3 -i ' + fname_src + ' -o ' +
                    fname_out + ' -t ' + ' '.join(fname_warp_list_invert) +
                    ' -r ' + fname_dest + interp, verbose)
