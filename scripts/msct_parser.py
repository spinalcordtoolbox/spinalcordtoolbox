...
class Option:
    ...
    ## Constructor
    def __init__(self, name, type_value, default_value, help):
        self.name = name
...
class Parser:
    ...
    def add_option(self, name, type_value=None, help=None, default_value=None):
        self.options[name] = Option(name, type_value, default_value, help)
