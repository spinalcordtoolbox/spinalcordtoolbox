...
def get_parser():
    ...
    parser.add_option(
        ...
        example=[
            ...
            'gm_model', 'optic_models', 'pmj_models', 'deepscseg_models', 'binaries_debian', 'binaries_centos', 'binaries_osx', 'course_hawaii17'
        ])
    parser.add_option(
        name="-v",
        type_value="multiple_choice",
...
def main(args=None):
    ...
    dict_url = {
        ...
        'deepscseg_models': 'https://osf.io/vpcjd//?action=download',
