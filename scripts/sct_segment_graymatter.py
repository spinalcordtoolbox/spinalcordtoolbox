...
def main(args=None):
    ...
    sct.display_viewer([param_seg.fname_im_original, seg_gm.fname_res_gmseg, seg_gm.fname_res_wmseg], l_colormap=['gray', gm_col, wm_col], l_opacity=['1', '0.7', '0.7'], verbose=param.verbose)
