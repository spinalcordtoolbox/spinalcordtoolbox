...
FOR %%D IN (PAM50 pmj_models deepseg_sc_models deepseg_gm_models deepseg_lesion_models binaries_win deepreg_models PAM50_normalized_metrics) DO sct_download_data -d %%D -k || goto error
