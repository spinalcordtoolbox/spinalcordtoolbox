...
**FEATURE**
 ...
 - **sct_deepseg**: Add `-custom-url` arg to alllow users to install specific `.zip`s for existing deepseg models. [View pull request](https://github.com/spinalcordtoolbox/spinalcordtoolbox/pull/4618)
