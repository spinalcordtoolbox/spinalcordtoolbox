...
FILES_TO_REMOVE="sct_otsu msct_nurbs sct_utils sct_dmri_eddy_correct sct_change_image_type sct_invert_image sct_convert msct_moco msct_parser msct_smooth sct_viewer"
