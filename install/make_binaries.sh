...
# program list
PROGRAM_LIST="isct_vesselness isct_propseg sct_change_nifti_pixel_type sct_detect_spinalcord isct_dice_coefficient sct_hausdorff_distance sct_modif_header isct_orientation3d isct_bsplineapproximator" #
